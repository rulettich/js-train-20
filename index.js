...
Car.prototype.brake = function (increase) {
  this.speed -= increase;
  console.log(
...
Truck.prototype.tow = function (weight) {
  if (weight > this.towingCapacity) {
    ...
    console.log("Буксирування почалося");
  }
};
...
Truck.prototype.toString = function () {
  return `Truck: ${this.brand} ${this.model} (${this.year}), Mileage: ${this.mileage}, Color: ${this.color}, Engine Type: ${this.engineType}, Towing Capacity: ${this.towingCapacity} lbs, Fuel Type: ${this.fuelType}, Transmission Type: ${this.transmissionType}, Doors: ${this.doors}, Weight: ${this.weight} lbs`;
};
...
ElectricCar.prototype.toString = function () {
  console.log(
    `${this.brand} ${this.model} ${this.year} - Пробіг: ${this.mileage}, Батарея: ${this.batteryCapacity} kWh`
  );
};
